                        ...
                        <div class="d-flex align-items-center justify-content-between flex-grow-1">
                            <div class="search-keyword">
                                <div class="search">
                                    ...
                                    <span class="button-search d-flex align-items-center justify-content-center"><i class="fas fa-search search-icon"></i></span>
                                    
                                </div>
                                <div class="bottom-header">
                                    <ul class="bottom-items">
                                        <li class="category-item--header"><a href="#" class="category-item--a">vòng cổ chữ A</a>
                                        </li>
                                        <li class="category-item--header"><a href="#" class="category-item--a">vòng cổ chữ A</a>
                                        </li>
                                        <li class="category-item--header"><a href="#" class="category-item--a">vòng cổ chữ A</a>
