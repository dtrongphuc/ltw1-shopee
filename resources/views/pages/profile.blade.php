                ...
                <div class="main__right">
                    ...
                    <div class="main__right-body row">
                        <div class="right__info col-8">
                            ...
                            @endif
                            <form autocomplete="off" action="{{route('update.account')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="col-sm-8 form-control" name="name" value="{{$user->name}}" placeholder="Tên người dùng">
                                </div>

                                <div class="form-group row">
                                    <label for="phoneNumber" class="col-sm-4 col-form-label">Số điện thoại</label>
                                    <input type="text" class="col-sm-8 form-control" name="phoneNumber" value="{{$user->phoneNumber}}" placeholder="Số điện thoại">
                                </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('change.account.password')}}"
                                                    method="POST" class="register__body-form">
                                                        <div class="form-group">
                                                            <!-- thêm  class 'is-invalid' để hiển thị thông báo khi nhập sai  -->
                                                            <input type="text" class="form-control" placeholder="Mật khẩu cũ" require name="old-password">
                                                        ...
                                                        <div class="form-group">
                                                            <!-- thêm  class 'is-invalid' để hiển thị thông báo khi nhập sai  -->
                                                            <input type="text" class="form-control" placeholder="Mật khẩu mới" require name="new-password">
                                                            <div class="invalid-feedback">
                                                                *Mật khẩu phải 8 kí tự trở lên
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <!-- thêm  class 'is-invalid' để hiển thị thông báo khi nhập sai  -->
                                                            <input type="text" class="form-control" placeholder="nhập lại mật khẩu" require name="confirm-password">
                                                            <div class="invalid-feedback">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 form-radio d-flex align-items-center">
                                        <div class="custom-control custom-radio d-flex align-items-center">
                                            <input id="male" type="radio" {{$user->gender == 'male' ? 'checked' : ""}} name="gender" class="custom-control-input" value="male">
                                            <label class="custom-control-label" for="male">Nam</label>
                                        </div>
                                        <div class="custom-control custom-radio d-flex align-items-center" style="margin-left: 20px;">
                                            <input type="radio" id="female" {{$user->gender == 'female' ? 'checked' : ""}} name="gender" class="custom-control-input" value="female">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" pattern="^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[1,3-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$" class="col-sm-8 form-control" name="birthday" placeholder="Ngày sinh" value="{{isset($user->birthday) ? \Carbon\Carbon::createFromFormat('Y-m-d', $user->birthday)->format('d/m/Y') : ""}}">
                                </div>
