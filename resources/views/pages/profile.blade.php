                        ...
                        <div class="main__right-body row">
                            <div class="right__info col-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="password" class="col-sm-6 form-control" placeholder="Mật khẩu" autocomplete="new-password" value="*************">
                            ...
                            <div class="col-4">
                                <div class="info__right-uploadimg">
                                    <div class="d-flex justify-content-center">
                                        <img id="img-info" src="{{ cloudinary()->getImage($user->avatar) }}" alt="" class="info__right-uploadimgimg" width="100px" height="100px">
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <label for="apply" class="lable-upload">
                                            <input class="info__right-uploadimg--btnupload" type="file" name="new-avatar" id="apply" accept="image/*" onchange="readURL(this);">Get file
                                        </label>
